...
private List<Candidato> seleccionados = new ArrayList<>();
	...
	public static SolucionEjercicio2 create(GraphPath<VertexEjercicio2, EdgeEjercicio2> camino) {
	...
	public String toString() {
		...
		Double salarioTotal = seleccionados.stream()
				.mapToDouble(Candidato::sueldoMin)
				.sum();
		
		Double valor = (double) seleccionados.stream()
